  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-slate-800">
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        <h1 className="text-3xl font-bold tracking-tighter text-[#064E3B]">Sign In</h1>
        <p className="text-slate-500">Access your personalized Algerian sports nutrition plan.</p>
